"""Compare late center fallbacks at pick 164 in the fixed Cade build."""
...
CANDIDATES = (
    "Moussa Diabate", "Jusuf Nurkic", "Deandre Ayton", "Khaman Maluach",
    "Yves Missi", "Robert Williams III", "Ryan Kalkbrenner", "Dereck Lively II",
    "Isaiah Jackson", "Isaiah Stewart", "Clint Capela", "Precious Achiuwa",
    "Andre Drummond",
)
OUTPUT = ROOT / "artifacts" / "analysis" / "pick164-centers-2027.json"
...
def run():
    ...
    for index in range(RUNS):
        ...
        for candidate in CANDIDATES:
            ...
            stressed = stress_rosters(rosters, 90_000 + index)
